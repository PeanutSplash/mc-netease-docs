...
*   备注
    ...
    *   由于玩家皮肤是异步加载的原因，该事件触发时机比[AddPlayerAOIClientEvent](#addplayeraoiclientevent)晚，触发该事件后可以对该玩家调用相关[玩家渲染接口](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/接口/玩家/渲染.html)。
...
*   备注
    ...
    *   对于玩家传入的参数，type不同则对应的value也不同，type对应value的类型和具体数据格式如下
        ...
        含有状态效果名称和对应的[EffectType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EffectType.html)枚举，如{'name': 'absorption', 'id': 22}
        ...
        含有生物群系名称和对应的[BiomeType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/BiomeType.html)枚举，如{'name': 'bamboo\_jungle', 'biomeType': 48}
        
        structure
        
        dict
        
        含有结构名称和对应的[StructureFeatureType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/StructureFeatureType.html)枚举，如{'name': 'ancient\_city', 'structureType': 15}
        
        enchant
        
        dict
        
        含有附魔名称和对应的[EnchantType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EnchantType.html)枚举，如{'identifier': 'knockback', 'type': 12}
...
*   参数
    ...
    期望响应的实体类型，不传则响应所有的实体类型[EntityType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EntityType.html)
...
*   参数
    ...
    掉落物品列表，每个元素为一个itemDict，格式可参考[物品信息字典](../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)
...
*   参数
    ...
    生成实体的类型，参考[EntityType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EntityType.html)
