---
title: "世界"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E4%BA%8B%E4%BB%B6/%E4%B8%96%E7%95%8C.html"
...
*   备注
    ...
    *   对于玩家传入的参数，type不同则对应的value也不同，type对应value的类型和具体数据格式如下
        ...
        含有状态效果名称和对应的[EffectType](/枚举值/EffectType)枚举，如{'name': 'absorption', 'id': 22}
        ...
        含有生物群系名称和对应的[BiomeType](/枚举值/BiomeType)枚举，如{'name': 'bamboo\_jungle', 'biomeType': 48}
        
        structure
        
        dict
        
        含有结构名称和对应的[StructureFeatureType](/枚举值/StructureFeatureType)枚举，如{'name': 'ancient\_city', 'structureType': 15}
        
        enchant
        
        dict
        
        含有附魔名称和对应的[EnchantType](/枚举值/EnchantType)枚举，如{'identifier': 'knockback', 'type': 12}
...
*   参数
    ...
    期望响应的实体类型，不传则响应所有的实体类型[EntityType枚举](/枚举值/EntityType)
...
*   参数
    ...
    生成实体的类型，参考[EntityType](/枚举值/EntityType)
