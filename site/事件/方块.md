...
*   参数
    ...
    | setBlockType | int | 方块进入脱离含雪的原因，参考[SetBlockType](/枚举值/SetBlockType) |
...
*   参数
    ...
    | y | int | 方块y坐标 |
    | z | int | 方块z坐标 |
    | face | int | 方块被敲击的面向id，参考[Facing枚举](/枚举值/Facing) |
    | fullName | str | 方块的identifier，包含命名空间及名称 |
    | auxData | int | 方块附加值 |
...
*   参数
    ...
    | y | int | 方块y坐标 |
    | z | int | 方块z坐标 |
    | setBlockType | int | 耕地退化为泥土的原因，参考[SetBlockType](/枚举值/SetBlockType) |
...
*   参数
    ...
    | pistonFacing | int | 活塞的朝向，参考[Facing枚举](/枚举值/Facing) |
    | pistonMoveFacing | int | 活塞的运动方向，参考[Facing枚举](/枚举值/Facing) |
...
*   参数
    ...
    | face | int | 方块被敲击面,参考[Facing枚举](/枚举值/Facing) |
