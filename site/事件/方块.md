---
title: "方块"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E4%BA%8B%E4%BB%B6/%E6%96%B9%E5%9D%97.html"
...
*   参数
    ...
    方块进入脱离含雪的原因，参考[SetBlockType](/枚举值/SetBlockType)
...
*   参数
    ...
    方块被敲击的面向id，参考[Facing枚举](/枚举值/Facing)
...
*   参数
    ...
    耕地退化为泥土的原因，参考[SetBlockType](/枚举值/SetBlockType)
...
*   参数
    ...
    活塞的朝向，参考[Facing枚举](/枚举值/Facing)
    
    pistonMoveFacing
    
    int
    
    活塞的运动方向，参考[Facing枚举](/枚举值/Facing)
