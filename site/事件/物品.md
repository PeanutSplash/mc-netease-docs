...
*   参数
    ...
    获得物品的方法，详见[ItemAcquisitionMethod](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ItemAcquisitionMethod.html)
...
*   参数
    ...
    获得物品的方法，详见[ItemAcquisitionMethod枚举](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ItemAcquisitionMethod.html)
...
*   参数
    ...
    使用物品的方法，详见[ItemUseMethodEnum枚举](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ItemUseMethodEnum.html)
...
*   参数
    ...
    容器类型，类型含义见：[容器类型枚举](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ContainerType.html)
...
*   参数
    ...
    当前界面类型,类型含义见：[容器类型枚举](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ContainerType.html)
...
*   参数
    ...
    玩家放入物品的[EnchantSlotType](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EnchantSlotType.html)
...
*   备注
    ...
    *   注意：避免在该事件回调中对玩家修改盔甲栏装备，如[SetEntityItem](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/接口/实体/背包.html#setentityitem)接口，会导致事件循环触发造成堆栈溢出。
...
*   参数
    ...
    容器槽位，含义见：[容器类型枚举](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/PlayerUISlot.html)
