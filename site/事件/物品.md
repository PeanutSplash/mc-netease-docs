...
*   参数
    ...
    设置为True可以取消，需要同时取消服务端事件[ItemReleaseUsingServerEvent](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E4%BA%8B%E4%BB%B6/#itemreleaseusingserverevent)
...
*   参数
    ...
    设置为True可以取消，需要同时取消客户端事件[ItemReleaseUsingClientEvent](https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E4%BA%8B%E4%BB%B6/#itemreleaseusingclientevent)
...
*   备注
    ...
    *   注意：避免在该事件回调中对玩家修改盔甲栏装备，如[SetEntityItem](/接口/实体/背包)接口，会导致事件循环触发造成堆栈溢出。
