---
title: "镜头效果"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E6%8E%A5%E5%8F%A3/%E5%90%8E%E5%A4%84%E7%90%86/%E9%95%9C%E5%A4%B4%E6%95%88%E6%9E%9C.html?catalog=1"
...
*   参数
    ...
    模糊半径值大小，值的范围为\[0,5\]，小于或大于这个范围的值将被截取为边界值0或5
...
*   参数
    ...
    远景模糊大小，值的范围为\[0,15\]，小于或大于这个范围的值将被截取为边界值0或15
...
*   参数
    ...
    焦点距离值大小，值的范围为\[0,100\]，小于或大于这个范围的值将被截取为边界值0或100。距离值接近100时将被视为无限远的远景。
...
*   参数
    ...
    近景模糊大小，值的范围为\[0,15\]，小于或大于这个范围的值将被截取为边界值0或15
...
*   参数
    ...
    是否开启景深效果屏幕中心聚焦模式，True为开启，False为关闭。开启后，原有的焦点距离设置将不再有效，接口SetDepthOfFieldFocusDistance也将失效。
...
*   参数
    ...
    颜色强度，值的范围为\[0,1\]，小于或大于这个范围的值将被截取为边界值0或1
    
    color
    
    tuple(float,float,float)
    
    颜色值，按顺序分别为颜色的RGB值，值的范围为\[0,255\]，小于或大于这个范围的值将被截取为边界值0或255
...
*   参数
    ...
    镜头污迹强度值大小，值的范围为\[0,1\]，小于或大于这个范围的值将被截取为边界值0或1
