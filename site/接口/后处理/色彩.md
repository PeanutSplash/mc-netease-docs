---
title: "色彩"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E6%8E%A5%E5%8F%A3/%E5%90%8E%E5%A4%84%E7%90%86/%E8%89%B2%E5%BD%A9.html?catalog=1"
...
*   参数
    ...
    亮度值大小，值的范围为\[0,5\]，小于或大于这个范围的值将被截取为边界值0或5
...
*   参数
    ...
    对比度值大小，值的范围为\[0,5\]，小于或大于这个范围的值将被截取为边界值0或5
...
*   参数
    ...
    饱和度值大小，值的范围为\[0,5\]，小于或大于这个范围的值将被截取为边界值0或5
...
*   参数
    ...
    色调强度，值的范围为\[0,1\]，小于或大于这个范围的值将被截取为边界值0或1
    
    color
    
    tuple(float,float,float)
    
    色调值，按顺序分别为颜色的RGB值，值的范围为\[0,255\]，小于或大于这个范围的值将被截取为边界值0或255
