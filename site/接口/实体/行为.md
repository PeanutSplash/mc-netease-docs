---
title: "行为"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E6%8E%A5%E5%8F%A3/%E5%AE%9E%E4%BD%93/%E8%A1%8C%E4%B8%BA.html"
...
*   参数
    ...
    轨迹起点，默认为None，表示以调用[StartEntityMotion](/接口/实体/行为#StartEntityMotion)的位置作为起点。
    ...
    实体到达targetPos时的朝向，受参数relativeCoord影响，默认为None，表示使用调用[StartEntityMotion](/接口/实体/行为#StartEntityMotion)时的朝向。
    
    startRot
    
    tuple(float,float)
    
    实体到达startPos时的朝向，受参数relativeCoord影响，默认为None，表示使用调用[StartEntityMotion](/接口/实体/行为#StartEntityMotion)时的朝向。
