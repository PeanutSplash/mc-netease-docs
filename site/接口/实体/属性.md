...
*   返回值
    ...
    原版组件名list，[EntityComponentType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EntityComponentType.html)
...
*   参数
    ...
    [AttrType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/AttrType.html)
...
*   返回值
    ...
    标记变种枚举值，获取失败返回-1，详见[马的标记变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/HorseSpotType.html)、[V2版村民服装枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/VillagerClothingType.html).
...
*   返回值
    ...
    颜色枚举值，详见[EntityColorType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EntityColorType.html)
...
*   返回值
    ...
    村民的交易等级，调用失败返回 -1，详见[TradeLevelType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/TradeLevelType.html)
...
*   返回值
    ...
    变种枚举值，获取失败返回-1，详见[猫变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/CatVariantType.html)、[马变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/HorseType.html)、[狐狸变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/FoxType.html)
...
*   参数
    ...
    [EntityComponentType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/EntityComponentType.html)
...
*   备注
    ...
    *   关于基础属性的原版最大值或最小值限制，可查看[AttrType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/AttrType.html)
...
*   参数
    ...
    变种枚举值，详见[马的标记变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/HorseSpotType.html)、[V2版村民服装枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/VillagerClothingType.html).
...
*   参数
    ...
    强度值，取值范围为 1~5，如果设置值大于[GetMobStrengthMax](#getmobstrengthmax)的值，将被设置为[GetMobStrengthMax](#getmobstrengthmax)的值
...
*   参数
    ...
    村民的交易等级，详见[TradeLevelType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/TradeLevelType.html)
...
*   参数
    ...
    变种枚举值，详见[猫变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/CatVariantType.html)、[马变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/HorseType.html)、[狐狸变种枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/FoxType.html)
