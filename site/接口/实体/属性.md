---
title: "属性"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E6%8E%A5%E5%8F%A3/%E5%AE%9E%E4%BD%93/%E5%B1%9E%E6%80%A7.html"
scraped_at: "2025-09-13T14:55:50.008Z"
...
*   返回值
    ...
    原版组件名list，[EntityComponentType枚举](/枚举值/EntityComponentType)
...
*   返回值
    ...
    标记变种枚举值，获取失败返回-1，详见[马的标记变种枚举](/枚举值/HorseSpotType)、[V2版村民服装枚举](/枚举值/VillagerClothingType).
...
*   返回值
    ...
    颜色枚举值，详见[EntityColorType枚举](/枚举值/EntityColorType)
...
*   返回值
    ...
    村民的交易等级，调用失败返回 -1，详见[TradeLevelType](/枚举值/TradeLevelType)
...
*   返回值
    ...
    变种枚举值，获取失败返回-1，详见[猫变种枚举](/枚举值/CatVariantType)、[马变种枚举](/枚举值/HorseType)、[狐狸变种枚举](/枚举值/FoxType)
...
*   参数
    ...
    [EntityComponentType枚举](/枚举值/EntityComponentType)
...
*   参数
    ...
    变种枚举值，详见[马的标记变种枚举](/枚举值/HorseSpotType)、[V2版村民服装枚举](/枚举值/VillagerClothingType).
...
*   参数
    ...
    强度值，取值范围为 1~5，如果设置值大于[GetMobStrengthMax](/接口/实体/属性#getmobstrengthmax)的值，将被设置为[GetMobStrengthMax](/接口/实体/属性#getmobstrengthmax)的值
...
*   参数
    ...
    村民的交易等级，详见[TradeLevelType](/枚举值/TradeLevelType)
...
*   参数
    ...
    变种枚举值，详见[猫变种枚举](/枚举值/CatVariantType)、[马变种枚举](/枚举值/HorseType)、[狐狸变种枚举](/枚举值/FoxType)
