---
title: "模型"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI/%E6%8E%A5%E5%8F%A3/%E6%A8%A1%E5%9E%8B.html"
...
*   备注
    ...
    *   如果需要[SetLegacyBindRot](/接口/模型#setlegacybindrot)，需先调用SetLegacyBindRot，再调用本接口
*   示例
...
*   参数
    ...
    | 参数名 | 数据类型 | 说明 |
    | --- | --- | --- |
    | brightness | float | 0：纯黑1：正常亮度1-14：较亮甚至纯白超过14：通常为纯白，即使数值改变也没有明显变化 |
