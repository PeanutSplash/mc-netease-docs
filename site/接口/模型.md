...
*   备注
    ...
    *   CPU蒙皮材质的说明可看[自定义材质](../../../mcguide/16-美术/6-模型和动作/04-骨骼模型的使用.html#7.模型使用自定义材质及更多贴图)，目前大多数设备都不会用到CPU蒙皮材质，仅在部分低端安卓设备中会使用CPU蒙皮材质。如果开发者如无需要，都可以不设置CPU蒙皮材质。如开发者有需要，则可以参考官方骨骼模型材质data/vanilla\_netease/materials/entity.material中的”entity\_for\_skeleton\_cpu“制作自己的CPU蒙皮材质。
*   示例
