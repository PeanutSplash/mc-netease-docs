---
title: "摄像机"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E6%8E%A5%E5%8F%A3/%E7%8E%A9%E5%AE%B6/%E6%91%84%E5%83%8F%E6%9C%BA.html"
...
*   参数
    ...
    轨迹起点，默认为None，表示以调用[StartCameraMotion](/接口/玩家/摄像机#StartCameraMotion)的位置作为起点。
    ...
    相机到达targetPos时的朝向，受参数relativeCoord影响，默认为None，表示使用调用[StartCameraMotion](/接口/玩家/摄像机#StartCameraMotion)时的朝向。
    
    startRot
    
    tuple(float,float,float)
    
    相机到达startPos时的朝向，受参数relativeCoord影响，默认为None，表示使用调用[StartCameraMotion](/接口/玩家/摄像机#StartCameraMotion)时的朝向。
