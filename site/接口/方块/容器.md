...
*   参数
    ...
    槽位，详见枚举[酿造台槽位](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/BrewingStandSlotType.html)
...
*   返回值
    ...
    [物品信息字典](../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)，没有物品则返回None
...
*   参数
    ...
    [开放容器Id枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/OpenContainerId.html)
...
*   备注
    ...
    *   需要在事件[CraftItemOutputChangeServerEvent](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/事件/物品.html#CraftItemOutputChangeServerEvent)的监听函数里面才能获取正确的结果
...
*   参数
    ...
    容器槽位。在isNeteaseUI为True时代表netease\_ui\_container中对应槽位；isNeteaseUI为False时含义见：[容器类型枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/PlayerUISlot.html)
    ...
    默认为false，true时获取netease\_ui\_container的物品
