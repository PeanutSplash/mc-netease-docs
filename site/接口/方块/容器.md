---
title: "容器"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI/%E6%8E%A5%E5%8F%A3/%E6%96%B9%E5%9D%97/%E5%AE%B9%E5%99%A8.html"
...
*   参数
    ...
    | 参数名 | 数据类型 | 说明 |
    | --- | --- | --- |
    | slot | int | 槽位，详见枚举[酿造台槽位](/枚举值/BrewingStandSlotType) |
...
*   返回值
    ...
    | 数据类型 | 说明 |
    | --- | --- |
    | dict | [物品信息字典](https://mc.163.com/dev/mcmanual/mc-dev/mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)，没有物品则返回None |
...
*   备注
    ...
    *   此接口不支持末影箱。对应的末影箱接口请参考 [GetEnderChestItem](/接口/方块/容器#getenderchestitem)
*   示例
...
*   参数
    ...
    | --- | --- | --- |
    | playerId | str | 玩家id |
    | containerId | int | [开放容器Id枚举](/枚举值/OpenContainerId) |
    | getUserData | bool | 是否获取userData，默认为False |
...
*   备注
    ...
    *   需要在事件[CraftItemOutputChangeServerEvent](/事件/物品#CraftItemOutputChangeServerEvent)的监听函数里面才能获取正确的结果
...
*   参数
    ...
    | --- | --- | --- |
    | playerId | str | 玩家id |
    | slot | int | 容器槽位。在isNeteaseUI为True时代表netease_ui_container中对应槽位；isNeteaseUI为False时含义见：[容器类型枚举](/枚举值/PlayerUISlot) |
    | getUserData | bool | 是否获取userData，默认为False |
...
*   参数
    ...
    | playerId | str | 玩家id |
    | slot | int | 容器槽位。在isNeteaseUI为True时代表netease_ui_container中对应槽位；isNeteaseUI为False时含义见：[容器类型枚举](/枚举值/PlayerUISlot) |
    | itemDict | dict | [物品信息字典](https://mc.163.com/dev/mcmanual/mc-dev/mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)，没有物品则返回None |
...
*   备注
    ...
    *   此接口不支持末影箱。对应的末影箱接口请参考 [SpawnItemToEnderChest](/接口/方块/容器#spawnitemtoenderchest)
