...
*   返回值
    ...
    | 数据类型 | 说明 |
    | --- | --- |
    | dict | [方块基本信息字典](https://mc.163.com/dev/mcmanual/mc-dev/mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#方块基本信息字典#方块基本信息字典) |
...
*   参数
    ...
    | --- | --- | --- |
    | blockName | str | 方块identifier |
    | infoDict | dict | 方块的[方块基本信息字典](https://mc.163.com/dev/mcmanual/mc-dev/mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#方块基本信息字典#方块基本信息字典) |
