...
*   备注
    ...
    *   返回值具体如下：
        ...
        命令方块类型，详见枚举[命令方块类型](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/CommandBlockType.html)
        
        "isConditional"
        
        int
        
        触发条件，详见枚举[命令方块条件类型](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ConditionType.html)
        
        "redstoneMode"
        
        int
        
        红石模式，详见枚举[命令方块红石类型](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/RedstoneModeType.html)
...
*   返回值
    ...
    [物品信息字典](../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)，获取失败或没有物品则返回None
...
*   参数
    ...
    方块类型，详见枚举[命令方块类型](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/CommandBlockType.html)
    
    isConditional
    
    int
    
    条件，详见枚举[命令方块条件类型](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/ConditionType.html)
...
*   参数
    ...
    详见[物品信息字典](../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)
