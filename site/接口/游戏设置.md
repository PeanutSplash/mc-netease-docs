...
scraped_at: "2025-09-13T09:58:47.022Z"
...
*   返回值
    ...
    按键映射字典，操作名：按键枚举值，详见[GamepadKeyType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/GamepadKeyType.html)和[KeyBoardType枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/KeyBoardType.html)
...
*   参数
    ...
    [SliderOptionId枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/SliderOptionId.html)
...
*   返回值
    ...
    \-1：类型不支持；返回值范围详见[SliderOptionId枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/SliderOptionId.html)
...
*   参数
    ...
    [OptionId枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/OptionId.html)
...
*   备注
    ...
    *   选择INPUT\_MODE时，返回值为 [InputMode枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/InputMode.html)
*   示例
...
*   参数
    ...
    值范围详见[SliderOptionId枚举](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/SliderOptionId.html)
