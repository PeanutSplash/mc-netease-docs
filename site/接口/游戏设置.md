---
title: "游戏设置"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI/%E6%8E%A5%E5%8F%A3/%E6%B8%B8%E6%88%8F%E8%AE%BE%E7%BD%AE.html"
...
*   返回值
    ...
    | 数据类型 | 说明 |
    | --- | --- |
    | dict | 按键映射字典，操作名：按键枚举值，详见[GamepadKeyType枚举](/枚举值/GamepadKeyType)和[KeyBoardType枚举](/枚举值/KeyBoardType) |
...
*   参数
    ...
    | 参数名 | 数据类型 | 说明 |
    | --- | --- | --- |
    | optionId | str | [SliderOptionId枚举](/枚举值/SliderOptionId) |
    
*   返回值
    
    | 数据类型 | 说明 |
    | --- | --- |
    | float | -1：类型不支持；返回值范围详见[SliderOptionId枚举](/枚举值/SliderOptionId) |
...
*   参数
    ...
    | 参数名 | 数据类型 | 说明 |
    | --- | --- | --- |
    | optionId | str | [OptionId枚举](/枚举值/OptionId) |
...
*   备注
    ...
    *   选择INPUT\_MODE时，返回值为 [InputMode枚举](/枚举值/InputMode)
*   示例
...
*   参数
    ...
    | --- | --- | --- |
    | optionId | str | [SliderOptionId枚举](/枚举值/SliderOptionId) |
    | value | float | 值范围详见[SliderOptionId枚举](/枚举值/SliderOptionId) |
