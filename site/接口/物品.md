...
包括物品属性的接口，物品的生成与获取见[玩家/背包](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/接口/玩家/索引.html#背包)，[实体/背包](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/接口/实体/索引.html#背包)，[方块/容器](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/接口/方块/索引.html#容器)，物品实体的生成与获取见[世界/实体管理](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/接口/世界/索引.html#实体管理)
...
*   返回值
    ...
    附魔信息字典[附魔信息字典](../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#附魔信息字典#附魔信息字典)
...
*   参数
    ...
    [物品信息字典](../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)。如果是接口获取的itemDict，应该包含userData，即getUserData应该为True
...
*   备注
    ...
    *   auxValue默认值是0，可以不设置。如果物品不存在，返回值为None
        ...
        附魔槽位枚举标志 [自定义附魔文档](../../../mcguide/20-玩法开发/15-自定义游戏内容/11-自定义附魔文档.html)
...
*   返回值
    ...
    [物品信息字典](../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典)
