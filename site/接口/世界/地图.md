...
*   参数
    ...
    原版的结构类型，[StructureFeatureType](/枚举值/StructureFeatureType)枚举
...
*   参数
    ...
    动画模式，详见[AnimationModeType](/枚举值/AnimationModeType)，默认值为0，即不使用动画
    ...
    镜像模式，详见[MirrorModeType](/枚举值/MirrorModeType)，默认值为0，即不使用镜像放置
