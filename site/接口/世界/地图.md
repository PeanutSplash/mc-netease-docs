...
*   参数
    ...
    原版的结构类型，[StructureFeatureType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/StructureFeatureType.html)枚举
...
*   参数
    ...
    动画模式，详见[AnimationModeType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/AnimationModeType.html)，默认值为0，即不使用动画
    ...
    镜像模式，详见[MirrorModeType](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/枚举值/MirrorModeType.html)，默认值为0，即不使用镜像放置
...
*   备注
    ...
    *   只支持设置已加载的坐标，支持设置2D和3D群系，3D群系有特殊规则(详情参考：[3D群系是特殊](../../../../mcguide/20-玩法开发/15-自定义游戏内容/4-自定义维度/2-群系地貌.html))
*   示例
...
*   备注
    ...
    *   只支持设置已加载的区块，设置超出维度范围的空间会被忽视掉，支持设置2D和3D群系，3D群系有特殊规则(详情参考：[3D群系是特殊](../../../../mcguide/20-玩法开发/15-自定义游戏内容/4-自定义维度/2-群系地貌.html))
*   示例
