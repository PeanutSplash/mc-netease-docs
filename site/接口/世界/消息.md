---
title: "消息"
source_url: "https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/%E6%8E%A5%E5%8F%A3/%E4%B8%96%E7%95%8C/%E6%B6%88%E6%81%AF.html?catalog=1"
...
*   参数
    ...
    颜色样式代码字符串，可参考wiki[样式代码 (opens new window)](https://zh.minecraft.wiki/w/%E6%A0%BC%E5%BC%8F%E5%8C%96%E4%BB%A3%E7%A0%81)，默认为白色
...
*   参数
    ...
    消息内容,可以在消息前增加extraServerApi.GenerateColor("RED")字符来设置颜色，具体参考样例
    
    subtitle
    
    str
    
    消息子标题内容,效果同message，也可设置颜色，位置位于message上方
...
*   参数
    ...
    消息内容,可以在消息前增加extraClientApi.GenerateColor("RED")字符来设置颜色，具体参考样例
...
*   参数
    ...
    状态值，0为原版开启状态，1为关闭，2为使用接口设置的物品dict中customTips的第一行作为弹出信息
