...
*   备注
    ...
    *   该接口触发[PlaySoundClientEvent](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/事件/音效.html#playsoundclientevent)
...
*   备注
    ...
    *   该接口触发[PlayMusicClientEvent](/dev/mcmanual/mc-dev/mcdocs/1-ModAPI-beta/事件/音效.html#playmusicclientevent)
    *   与示例对应的sound\_definitions.json配置：
